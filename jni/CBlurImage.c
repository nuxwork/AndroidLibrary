...
JNIEXPORT void JNICALL Java_com_swordy_library_android_libs_image_BlurImage_generate(JNIEnv* env, jobject obj, jobject bitmapIn, jobject bitmapOut, jint radius) {
